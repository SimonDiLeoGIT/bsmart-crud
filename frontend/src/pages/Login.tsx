  ...
  return (
    ...
    >
      ...
      <input 
        ...
        minLength={3} 
        maxLength={30} 
        className="p-2 border-b-2 border-violet-300 focus:border-violet-400 focus:outline-none"
      />
      <input 
        name='password' 
        type="password" 
        ...
        className="p-2 border-b-2 border-violet-300 focus:border-violet-400 focus:outline-none"
      />
      <p className="text-center text-sm -text--color-black opacity-90 mt-4">You don't have an account? <Link to="/register" className="text-violet-900 border-b border-violet-900 hover:opacity-60">Sign up</Link></p>
      <button 
        type="submit"
